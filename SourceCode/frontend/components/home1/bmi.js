                ...
                <div className='rounded-2xl overflow-hidden border border-slate-100 shadow-[0_4px_30px_-8px_rgba(0,0,0,0.08)] flex flex-col'>
                    ...
                    <div className='border-t border-slate-100 px-6 py-4 bg-slate-50/50'>
                        <p className='text-[12px] text-gray-500 font-medium'>
                            <span className='font-black text-[#F97316]'>{i18n?.t('BMR')}</span> {i18n?.t('– Basal Metabolic Rate')} &middot;
                            <span className='font-black text-[#F97316]'>{i18n?.t('BMI')}</span> {i18n?.t('– Body Mass Index')}
                        </p>
                    </div>
                </div>
