...
const UsersPageContent = () => {
    ...
    return (
        <div>
            ...
            <Table
                ...
                action={(
                    <div className='flex gap-2'>
                        <Button className='!h-fit !py-[6px]' onClick={() => setOpen(true)}>
                            {i18n?.t('Add Member')}
                        </Button>
                        <div className='dashboardSelect'>
                            <Select
                                allowClear
                                placeholder={<h3 className='!text-textMain'>{i18n?.t('Filter Subscription')}</h3>}
                                style={{ minWidth: 150 }}
                ...
                >
                    {!renue && (
                        <>
                            ...
                            <FormPassword name='confirm_password' label={'Confirm Password'} required={true} confirm placeholder={"Enter Confirm Password"} />
                            <h3 className='mb-3 mt-4 font-semibold text-black text-opacity-[88%]'>{i18n?.t('Include Subscription')}</h3>
                        </>
                    )}
                    <FormSelect
                        name='subscription'
            ...
            >
                <Form form={resetForm} onFinish={handleResetPassword} layout='vertical' className='space-y-4'>
